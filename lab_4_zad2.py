import datetime
from lab_4_zad1 import Student
...
class Employee:
    def __init__(self, first_name: str, last_name: str, hire_date: datetime.date, birth_date: datetime.date,
...
class Book:
    def __init__(self, library: Library, publication_date: datetime.date, author_name: str, surname: str, pages: int):
    ...
    def __str__(self):
        return f"""
        Book written by: {self.author_name} {self.surname}, 
...
employee_1 = Employee("Anna", "Nowak", datetime.date(2017, 1, 1), datetime.date(1989, 12, 12),
                      "Zabrze", "Szkolna 13", "43-210", "+481234567")
employee_2 = Employee("Aniela", "Kowal", datetime.date(2010, 3, 23), datetime.date(1979, 1, 24),
                      "Kalety", "Wolna 4", "32-345", "+48111111111")
employee_3 = Employee("Arkadiusz", "Morawiecki", datetime.date(2010, 5, 22), datetime.date(1967, 10, 25),
                      "Bytom", "Wroclawska 43", "33-333", "+48345345345")
